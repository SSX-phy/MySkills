# <Topic> — literature sweep

*Sweep performed: <YYYY-MM-DD>. Corpus size: <N> kept (<M> dropped). Hop depth: <1|2>.*
...
> *Coverage caveat:* forward-citation coverage is incomplete because [reason]. Recent work on [area] may not be represented.
...
What the corpus does **not** cover. Bulleted, no citations needed (these are absences).
...
Short list of papers worth reading after this sweep but not deeply read here. Link each.

- [Author Year](https://doi.org/...) — one-sentence reason.

---

## Crucial sources

Three to seven papers the user should read deeply. Each entry: link + one-sentence justification.

1. [Author Year](https://doi.org/...) — why this paper is foundational / pivotal for the topic.
2. [Author Year](https://doi.org/...) — what this paper uniquely contributes.
3. ...
